...
function showFields() {
    ...
    const selectedOption = sectionType.options[sectionType.selectedIndex];
    ...
    if (sectionType.value === "UPN") {
        ...
        // قم بتعيين مسار الصورة للعنصر sectionImage
